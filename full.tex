...
\subsection{Enquête}
Vooraf het maken van ons model is aan alle docenten van Het Amsterdams Lyceum gevraagd wat hun gedachtes waren over het nakijken m.b.v. artificiële intelligentie.
In de enquête werden diverse vragen gesteld om een breed beeld te krijgen van de standpunten en ervaringen van de docenten. Zo werd er gevraagd naar hun vakgebied en het aantal jaren dat ze al voor de klas staan. Ook werd geïnformeerd naar hun bekendheid met (generatieve) AI. Belangrijke thema's waren de redenen waarom docenten AI zouden willen gebruiken bij het nakijken van proefwerken en de zorgen die ze hierbij hebben. Daarnaast werd er gevraagd of zij denken dat AI zelfstandig toetsen kan nakijken en hoeveel leerlingen doorgaans hun beoordeling in twijfel trekken. Tot slot werd er ingegaan op de mogelijke invloed van AI op de relatie tussen docent en student.
