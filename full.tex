...
\multicolumn{1}{c}{Stap} & \multicolumn{1}{c}{Code} & \multicolumn{1}{c}{Voorbeeld}
    ...
    1. checkbox herkenning & 
            \adjustbox{valign=t}{\includegraphics[width=\linewidth]{./images/methoden/inscannen/sectie/checkbox/vraagnummer/yolov_code.png}}
           &
            \adjustbox{valign=t}{\includegraphics[width=\linewidth]{./images/methoden/inscannen/sectie/checkbox/yolov5.jpg}}
           \\
    \hline
    \hline
    2. Meest gevulde checkbox kiezen  & 
        \adjustbox{valign=t}{\includegraphics[width=\linewidth]{./images/methoden/inscannen/sectie/checkbox/vraagnummer/yolov_test.png}}
           &
