...
\multicolumn{1}{c}{Stap} & \multicolumn{1}{c}{Voorbeeld}
    ...
    \hline
    2. Dan wordt er een blur gebruikt om de contrasten te vinden (\cite{gaussianBlurOriginal}). & 
...
\subsection{Analyseren}
\begin{multicols}{2}
% TODO: zeggen dat dit met ai gemaakt is
...
$\bullet$ We kregen terug van een aantal docenten dat de vraag aantal leerlingen die het oneens is met een becijfering niet exact gedefineerd was.\\
$\bullet$ Er waren relatief weinig gamma resultaten, waardoor hun reactie statisch gezien minder waarde heeft.\\
...
\begin{multicols}{2}
Het doel van dit onderzoek was om een programma te maken die het nakijken uit de handen van een docent neemt. \\
\\
Uit de enquete blijkt dat het grootste deel van de docenten de tijdsbesparing het grootste voordeel vindt. Dit doel hebben we bereikt doore en klas in te scannen in een paar minuten en na te kijken in een paar minuten. Daarnaast kost het geen extra moeite, naast het inscannen in een printer.\\
\\
De grootste zorg die docenten hadden is dat een ai te weinig aandacht had voor subjectieve beoordelingen en technische fouten. Uit het toetsje wat we hebben gegeven blijkt dat 
TODO: wat blijkt uit het toetsje
\\
TODO: afsluiting
